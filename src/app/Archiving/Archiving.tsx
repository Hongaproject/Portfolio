    ...
    <section className="min-h-screen" aria-labelledby="share-heading">
      ...
      <main className="mt-12" role="main">
        ...
        <article className="mt-12" aria-labelledby="velog-heading">
          <h2 id="velog-heading" className="text-3xl font-semibold mb-4">
            Velog
          </h2>
          <h3 className="text-xl mb-3 flex items-center">
            <img
            ...
            >
              velog.io/@hongga/posts
            </Link>
          </h3>
          <span className="text-xl">
            <strong>공부 및 지식 공유 목적의 블로그</strong>입니다.
          </span>
          <ul
            className="mt-4 list-disc pl-8 text-xl space-y-2"
            aria-label="벨로그 관련 항목"
          >
