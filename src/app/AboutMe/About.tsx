...
export default function About() {
    ...
    <nav className="flex flex-col items-center justify-between bg-slate-500 md:w-1/5 py-16">
    ...
    <main className="bg-black bg-opacity-20 md:w-4/5 flex flex-col container mx-auto px-5 py-20 items-center justify-center">
