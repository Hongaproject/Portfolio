      ...
      <main className="mt-12" role="main">
        ...
        >
          ...
          <span className="block text-lg mb-5">
            2024/08/07 ~ 2024/08/13 (1인 프로젝트)
          </span>
          <span className="block text-xl mb-5">
            <strong>포트폴리오를 제작하기 위해 개발했습니다.</strong> <br />
            <br />
            Next.js와 Tailwind CSS를 사용해 사이트를 구성하고, TypeScript를 통해
            더 안전한 코드 작성을 경험했습니다.
            <br />
            <br />
            포트폴리오 사이트를 제작하며 Next.js와 TypeScript를 사용해 React와
            JavaScript의 차이점을 공부했습니다. 또한, 작업 후 웹 접근성을 고려한
            개선과 코드 리팩토링을 통해 코드의 가독성과 유지보수성을 높이는
            경험을 했습니다. <br />
          </span>
          <div className="mb-5">
          ...
          <div>
            ...
            <div className="border-2 rounded-lg">
              {portfolioSkils.map((skill, index) => (
                <div key={index}>
                  <div
                    className="py-2 border-2 pl-2 flex cursor-pointer"
                    role="button"
        ...
        <article
          className="lg:max-w-3xl lg:w-full md:mb-0 pb-20"
          aria-labelledby="alcohol-heading"
        >
          ...
          <span className="block text-xl mb-5">
            <strong>대한민국 술 종류를 소개하는 사이트</strong>입니다. 주류
            판매점을 구경 갔다가 대한민국에 주류가 몇 개가 있을까? 사람들이 자주
            먹는 술은 어떻게 만들어지고 어떤 역사가 있을까에 대해 궁금증이
            생겨서 개발하게 되었습니다. <br />
            <br />
            Pigma를 사용해서 디자인을 직접 제작했으며 React를 사용해서
            개발했습니다. Firebase를 사용해서 로그인 및 회원가입, store를
            사용했고 Context API를 사용해서 상태 관리를 진행했습니다. 또한
            메일을 보낼수 있게 도와주는 email JS를 사용했으며,
            styled-components를 사용해서 스타일을 적용했습니다. <br />
            <br />
            상태관리와 다양한 라이브러리를 사용해 볼 수 있어서 배울점이
            많았습니다. <br />
            현재도 사용자에게 의견을 받으면서 업데이트를 진행하고 있습니다.{" "}
            <br />
            <br />
            또한, 작업 후 웹 접근성을 고려한 개선과 코드 리팩토링을 통해 코드의
            가독성과 유지보수성을 높이는 경험을 했습니다. <br />
          </span>
          <div className="mb-5">
            <h2 className="text-2xl mb-3 font-bold flex items-center">
              <img
        ...
        >
          ...
          />
          <span className="block text-lg mb-5">
            2024/09/23 ~ 2024/10/22 (Front-End 4인)
          </span>
          <span className="block text-xl mb-5">
            <strong>요리 레시피를 알려주는 사이트</strong>입니다. 팀원들끼리
            서로 아이디어를 모아서 결정했습니다. <br />
            <br />
            Pigma를 사용해서 디자인 틀을 제작했으며, 작업 진행 도와 일정 관리를
            위해 Jira를 사용했습니다. 사용 개발은 React와 TypeScript를 사용해서
            제작했습니다. <br />
            <br />
            제 역할은 회원가입, 프로필 페이지 제작을 담당했습니다. Firebase를
            사용해서 회원가입 구현을 제작했으며, 이메일과 닉네임 중복체크 기능을
            추가했습니다. <br />
            프로필 페이지는 Firestore를 사용하여 사용자 정보를 가져와서
            제작했고, 회원 정보 수정과 게시글, 좋아요한 게시물들을 확인할 수
            있는 기능을 구현했습니다.
            <br />
            <br />
            이번 프로젝트를 진행하면서 소통의 중요성을 느꼈습니다. 팀원들과
            의견을 교환하고 서로의 아이디어를 조율하면서 다양한 문제를 해결할 수
            있었습니다. <br />
            특히, 기술적인 문제나 의견 충돌이 있을 때 적극적으로 소통하며
            해결하는 과정에서 소통의 중요성을 알게 되었습니다.
            <br />
          </span>
          <div className="mb-5">
            <h2 className="text-2xl mb-3 font-bold flex items-center">
