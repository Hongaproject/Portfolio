        ...
        <section className="min-h-screen" aria-labelledby="share-heading">
            ...
            <main className="mt-12" role="main">
                <article aria-labelledby="github-heading">
                    ...
                    <h3 className="text-xl mb-3 flex items-center"><img src="/img/link.png" alt="" aria-hidden="true" className="mr-2"/>
                        깃허브 주소 : <Link href='https://github.com/Hongaproject' target="_blank" className="text-sky-500 hover:underline ml-1" aria-label="깃허브 사이트로 이동">github.com/Hongaproject</Link>
                    </h3>
                    <span className="text-xl"><strong>소스 코드 저장소</strong>입니다.</span>
                    <ul className="mt-4 list-disc pl-5 text-xl space-y-2" aria-label="깃허브 관련 항목">
                ...
                <article className="mt-12" aria-labelledby="velog-heading">
                    ...
                    <h3 className="text-xl mb-3 flex items-center"><img src="/img/link.png" alt="" aria-hidden="true" className="mr-2"/>
                        블로그 주소 : <Link href='https://velog.io/@hongga/posts' target="_blank" className="text-sky-500 hover:underline ml-1" aria-label="벨로그 사이트로 이동">velog.io/@hongga/posts</Link>
                    </h3>
                    <span className="text-xl"><strong>공부 및 지식 공유 목적의 블로그</strong>입니다.</span>
                    <ul className="mt-4 list-disc pl-5 text-xl space-y-2" aria-label="벨로그 관련 항목">
